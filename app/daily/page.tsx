 ...
 * 2026-06-02 | 날짜 이동 기능 추가 (이전/다음 날 이동)
 * 2026-06-02 | 공통 유틸 함수 lib/utils.ts로 분리
 */
...
export default function DailyPage() {
    ...
    // 날짜 바뀔 때마다 localStorage에서 해당 날짜 데이터 불러오기
    useEffect(() => {
        const key = `dailyData_${dateToKey(selectedDate)}`;
